...
\chapter{API}
\todo[inline]{
 * Explain how it's RESTful
    - Examples how the status codes are used
    - Explanation for choosing some HTTP methods
 * Give some examples
    - Especially for CSRF
 * Manually writing the whole API blueprint documentation?
}
