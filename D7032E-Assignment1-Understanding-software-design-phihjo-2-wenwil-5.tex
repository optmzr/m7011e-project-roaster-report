...
The website will not be very big or complicated when it comes to number of pages and views.
...
We could have written the website with pure \textit{vanilla} javascript b
...
The proof of concept is finished for Roaster and the service works as we wanted, but there are several ways to extend the service and improve it.
